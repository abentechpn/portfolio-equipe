const membres = [
  {
    ...
    parcours: "Etudiant a l'ISTEAH en genie logiciel. Passionne par le design d'interfaces et l'accessibilite numerique depuis ses premiers projets universitaires.",
